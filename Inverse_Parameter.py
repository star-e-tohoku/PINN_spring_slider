...
#Parameter for synthtic observation data
obs_error = 0.1
obs_start = 0
obs_end = t2 - t1
obs_span = time_span

#First guess values of fricitonal parameters per true values
a_ini = 10
a_b_ini = 0.1
dc_ini = 10
...
seed = 1234
max_iteration = 20000
fp_epsilon = 1e-5 #convergence condition for fricitonal parameters

#Output
filename = "PINN_SSE_Inverse"
